...
\begin{enumerate}
    ...
    \begin{enumerate}[label*=\arabic*.]
        \begin{multicols}{2}
                ...
                \item ${\int\limits_{\frac{\pi}{2}}^{\pi}\sin\! \left(2 y\right)d y}$;

                \item ${\int\limits_{1}^{2}\left(3 x-6\right)d x}$;

                \item ${\int\limits_{0}^{1}\left(\frac{1}{2} x^{3}-\frac{1}{2} x^{2}-\frac{1}{2} x+\frac{1}{2}\right)d x}$;

                \item ${\int\limits_{0}^{1}x \left(-x^{3}-x+2\right)d x}$;

                \item ${\int\limits_{-1}^{2}\left(y^{3}-3 y^{2}+4\right)d y}$;

                \item ${\int\limits_{1}^{4}\frac{y^{\frac{3}{2}}}{12}d y}$;

                \item ${\int\limits_{0}^{1}\left(1-{\mathrm e}^{-x}\right)d x}$;

                \item ${\int\limits_{0}^{1}\frac{y^{2} \pi}{2}d y}$.
        \end{multicols}
    \end{enumerate}
\end{enumerate}
